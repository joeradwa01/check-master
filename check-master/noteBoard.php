...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Sticky Note <?php echo $boardId ?></title>
                            ...
                            <div class="container-fluid collapse-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 p-0 d-flex justify-content-end">
                                        ...
                                        <button class="btn btn-primary ml-2" data-extra-toggle="toggle" data-extra-class-show=".show-note-button" data-extra-class-hide=".hide-note-button" id="save"  value="1" onclick="newElement()">Save</button>
                                    </div>
            ...
            <div class="card card-block card-stretch pb-2">
                <div class="card-body write-card pb-4">
                    <div class="row">
                        ...
                        <input type="text" class="form-control" name="email" value="<?php $email?>" placeholder="<?php $_SESSION['email'];?>">
                         </div>
